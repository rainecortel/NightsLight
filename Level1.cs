...
namespace NightsLight
{
    internal class Level1 : Form
    {
        ...
        private void InitializeForm()
        {
            ...
            this.BackgroundImage = Image.FromFile(AppDomain.CurrentDomain.BaseDirectory + "\\Assets\\Images\\Map001.png");

            // Set the sound for Level 1
            SoundPlayer simpleSound = new SoundPlayer(AppDomain.CurrentDomain.BaseDirectory + "\\Assets\\Audio\\Town1.wav");
            simpleSound.Play();
        ...
        private void playerImages()
        {
            ...
            playerMovements = Directory.GetFiles(AppDomain.CurrentDomain.BaseDirectory + "\\Assets\\Player\\", "*.png").ToList();
